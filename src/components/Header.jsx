...
import avatarImage from '@/app/uc.png'
    ...
    <Popover {...props}>
      ...
      >
        <div className="flex flex-row-reverse items-center justify-between">
          <PopoverButton aria-label="Закрыть меню" className="-m-1 p-1">
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            ...
            <MobileNavItem href="/sveden">
              Сведения об образовательной организации
            </MobileNavItem>
            <MobileNavItem href="/contacts">Контакты</MobileNavItem>
          </ul>
        </nav>
      </PopoverPanel>
    </Popover>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        ...
        <NavItem href="/sveden">Сведения об образовательной организации</NavItem>
...
function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      aria-label={mounted ? `Переключить на ${otherTheme === 'dark' ? 'темную' : 'светлую'} тему` : 'Переключить тему'}
