...
export const article = {
  author: 'Адам Уотан',
  date: '2022-09-02',
  title: 'Представляем Animaginary: Высокопроизводительные веб-анимации',
  description:
    'Когда вы создаете веб-сайт для такой амбициозной компании, как Planetaria, вам нужно произвести впечатление. Я хотел, чтобы люди посещали наш веб-сайт и видели анимации, которые выглядят более реалистично, чем сама реальность.',
}
...
Чтобы сделать это возможным, нам нужно было выжать каждую каплю производительности из браузера. И так родился Animaginary.
...
Animaginary — это наша новая библиотека веб-анимации, которая переопределяет то, что вы считали возможным в вебе. Написанная вручную на оптимизированном WASM, Animaginary может даже анимировать свойство `height` элемента со скоростью 60fps.
