...
export const article = {
  author: 'Адам Уотан',
  date: '2022-09-05',
  title: 'Создание дизайн-системы для межпланетного будущего',
  description:
    'Большинство компаний пытаются опережать тенденции в визуальном дизайне, но для Planetaria нам нужно было создать бренд, который будет вдохновлять нас через 100 лет, когда человечество распространится по всей нашей солнечной системе.',
}
...
Я знал, что для правильного результата мне нужно воспроизвести условия просмотра человека из будущего, поэтому я достал свой космический шлем из шкафа, создал новый документ Figma и приступил к работе.
